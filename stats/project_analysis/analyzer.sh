...
sudo rm -rf vendor
composer install
COMPOSER_CACHE_DIR=/tmp/cache$5 sudo php -d sys_temp_dir=/var/lib/drupalci/workspace/drupal-checkouts/drupal$5 ./vendor/bin/drush si --db-url=sqlite://sites/default/files/.ht.sqlite -y
COMPOSER_CACHE_DIR=/tmp/cache$5 sudo php -d sys_temp_dir=/var/lib/drupalci/workspace/drupal-checkouts/drupal$5 ./vendor/bin/drush en upgrade_status -y
