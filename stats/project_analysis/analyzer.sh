...
# Remove phpstan.neon because it is not needed for rector and causes some modules to fail.
rm /var/lib/drupalci/workspace/drupal-checkouts/drupal$5/phpstan.neon
