...
if [ "${uri}" != "staging.devdrupal.org" -a "${uri}" != "infrastructure.staging.devdrupal.org" -a "${uri}" != "assoc.staging.devdrupal.org" -a "${uri}" != "events.staging.devdrupal.org" -a "${uri}" != "api.staging.devdrupal.org" ]; then
  # Copy snapshot.
