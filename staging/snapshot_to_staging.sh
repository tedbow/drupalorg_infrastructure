...
if [ "${uri}" != "staging.devdrupal.org" -a "${uri}" != "infrastructure.staging.devdrupal.org" -a "${uri}" != "assoc.staging.devdrupal.org" -a "${uri}" != "events.staging.devdrupal.org" -a "${uri}" != "api.staging.devdrupal.org" -a "${uri}" != "jobs.staging.devdrupal.org" -a "${uri}" != "jobs.devdrupal.org" -a "${uri}" != "qa.staging.devdrupal.org" ] || [ "${suffix-}" == "civicrm" ]; then
  # Copy snapshot.
