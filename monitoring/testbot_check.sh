...
TESTBOTS=`/usr/bin/drush sqlc < /usr/local/drupal-infrastructure/monitoring/testbot_check.sql |awk 'NR > 1 {system curl --data print "Client #" $4 ": " $5 " Stalled for more than 1 hour. Last activity was : " $1,$2} '`
